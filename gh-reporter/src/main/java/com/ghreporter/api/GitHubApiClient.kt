...
object GitHubApiClient {
    ...
    private class AuthInterceptor(private val tokenStorage: SecureTokenStorage) : Interceptor {
    ...
    private class DirectAuthInterceptor(private val token: String) : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            val authenticatedRequest =
